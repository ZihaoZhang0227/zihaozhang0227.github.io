$(function() {
	var playVideo = $('video');
	var playPause = $('.playPause'); //play and pause
	var currentTime = $('.timebar .currentTime'); //time
	var duration = $('.timebar .duration'); //totle_time
	var progress = $('.timebar .progress-bar'); //time_bar
	var volumebar = $('.volumeBar .volumewrap').find('.progress-bar');
	playVideo[0].volume = 0.4; //volume
